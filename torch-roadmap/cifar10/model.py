...
def getDataLoaders(batch_size=64):
    ...
    train_dataset = datasets.CIFAR10(root="~/.pytorch/cifar100/", train=True, download=True, transform=transform)
    train_loader = DataLoader(train_dataset, batch_size=batch_size, shuffle=True)

    test_dataset = datasets.CIFAR10(root="~/.pytorch/cifar100/", train=False, download=True, transform=transform)
